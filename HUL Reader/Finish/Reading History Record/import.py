#Need change database name in query [File from \\balt-apps01-srv\MVRS50\HUL Files]
...
#End Add New [RRM, RTP] 2016.1.19
        ...
        """INSERT INTO MVRS_New(
          ...
          {"a":accountNumber,"m":meterNumber,"c":comment,"r":rdgRead,"rd":readDate,"rt":readTime,"rc":readCode,\
           "sc":skipCode,"tc1":tCode1,"tc2":tCode2,"mri":mReaderId,"rty":readType,"pr":preReading,"rm":readMethod,"tp":textPrompt,"fn":file})
        cusCnt+=1
    f.close()
